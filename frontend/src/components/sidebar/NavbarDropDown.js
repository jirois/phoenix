        ...
        className={`${isToggle? 'sidebar open' : 'sidebar'}`}>
            <nav className="top-0 left-0 right-0 flex flex-col w-5/6 max-w-sm mx-auto py-6 px-6 overflow-y-auto ">
                ...
                <div>
                   ...
                   return(
                       <li key={id} className="mb-1">
                            <a  className="text-sidebar" href={url}>{text}</a>
                       </li>
                   )
                ...
                <div className="mt-auto">
                    <div className="pt-6">
                        <a className="block px-4 py-3 mb-3 leading-loose text-xs text-center text-black font-semibold leading-none bg-gray-50 hover:bg-gray-100 rounded-xl" href="#">Sign In</a>
                        <a className="block px-4 py-3 mb-2 leading-loose text-xs text-center text-white font-semibold bg-blue-700 hover:bg-blue-800  rounded-xl" href="#">Sign Up</a>
                    </div>
