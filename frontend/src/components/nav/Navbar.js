...
function Navbar(props) {
    ...
    return (
        <>
        <nav className="relative px-4 py-4 flex justify-between bg-transparent text-center z-10">
            <a className="menu-logo text-3xl font-bold leading-none" href="/">
            ...
            <div className="md:flex lg:hidden -top-1">
                {/* <button className="flex text-center text-blue-600 p-3 cursor-pointer" onClick={openLink}>
