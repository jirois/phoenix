    ...
    <>
      ...
      <div className="max-w-screen-xl mt-12 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg">
        <div className="flex flex-col justify-between">
          <div>
            <h4 className="text-3xl lg:text-3xl font-bold leading-tight">
              Send us a message!
            </h4>
            <div className="text-gray-700 mt-8">
              <ul className="p-0">
                <li>
                  We've driven online revenues for our students. Ready to know
                  how we can help you?
                </li>
                <span className="font-semibold text-1xl ">
                  <li className="mt-5 flex font-extrabold text-black">
                    <FaEnvelope className="text-xl mr-1" />{" "}
                    info@phoenixcapng.com
                  </li>
                  <li>
